...
- 难度：HARD
- 标签：数据库
- 来源：https://leetcode.cn/problems/find-invalid-ip-addresses/
- 归档：2026-08-12T16:39:41Z
...
```text
{"headers": {"logs": ["log_id", "ip", "status_code"]}, "rows": {"logs": [[8, "127.0.0.1", 200], [9, "192.168..1", 400]]}}
```
