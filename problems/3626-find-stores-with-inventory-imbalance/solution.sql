...
FROM stores s
JOIN chosen c ON s.store_id = c.store_id
JOIN store_counts sc ON sc.store_id = c.store_id
WHERE sc.product_count >= 3 AND c.expensive_quantity < c.cheap_quantity
